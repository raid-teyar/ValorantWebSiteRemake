...
$('.animation').hide().eq(random).show();

var randomm = Math.floor(Math.random() * $('.animationn').length);
$('.animationn').hide().eq(randomm).show();

var randommm = Math.floor(Math.random() * $('.animationnn').length);
$('.animationnn').hide().eq(randommm).show();